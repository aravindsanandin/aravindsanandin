...
Passionate about building real-time data pipelines and analytics systems.
...
> Real-time data pipeline processing 20,000+ transactions across 15 global stores in 10 countries.

**Full Pipeline:**
```
Python → Apache Kafka → Apache Spark → Bronze/Silver/Gold Data Lake → DuckDB → Streamlit
```

[![GitHub](https://img.shields.io/badge/View_Project-181717?style=flat&logo=github&logoColor=white)](https://github.com/aravindsanandin/Apple-Scale-Retail-Data-Platform)
[![Demo](https://img.shields.io/badge/Watch_Demo-FF0000?style=flat&logo=youtube&logoColor=white)](https://youtu.be/WfVg-zzc0X0)

---

### ☁️ AWS Data Reliability Pipeline
> Production-style AWS pipeline that cleans, validates, and transforms messy raw data before it reaches analytics.

**Full Pipeline:**
```
S3 Bronze → AWS Glue ETL → Data Validation → S3 Silver → Gold Aggregation → Amazon Athena
```

**Key Features:**
- Schema enforcement + duplicate removal
- Date standardization + null detection
